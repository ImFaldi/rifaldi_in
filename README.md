...
# Internal analytics dashboard (server-side API)
GOOGLE_ANALYTICS_CLIENT_EMAIL=service-account@project-id.iam.gserviceaccount.com
GOOGLE_ANALYTICS_PRIVATE_KEY="-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----\n"
GA4_PROPERTY_ID=123456789

# Optional: fetch GTM tags list in internal dashboard
